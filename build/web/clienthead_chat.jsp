<%-- 
    Document   : clienthead_chat
    Created on : May 12, 2018, 1:28:25 AM
    Author     : HP
--%>
...
<html>
    <head>
        ...
        function ()
        {
        $('#load_me').load('print_clienthead_table.jsp').fadeIn("slow");
        }, 5000); 
...
}else r = (String) session.getAttribute("r");g = (String) session.getAttribute("g"); n= (String) session.getAttribute("n");num= (String) session.getAttribute("num");
            ...
            <tbody>
                <tr>
                    ...
                    <td width="900px" align="center">
                        <img src="pho/bb_1.jpg" width="700" height="100" style="border-radius: 10px;"> 
                    </td><td align="left" width="300px" style="color: white; vertical-align: bottom;">   
<br><p style="font-size:16px;text-align: left"> You are logged-in.</p><p style="font-size:23px;text-align: left">Hi <%=g %><%=r %><br><%=n %><br><%=num %></p>
    ...
    <tr> 
        ...
        <form name="f" action="Send_other" method="post">
...
<div id="load_me">
<%@ include file="print_clienthead_table.jsp" %>
</div>
