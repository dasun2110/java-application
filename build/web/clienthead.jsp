<%-- 
    Document   : clienthead
    Created on : May 4, 2018, 11:05:58 AM
    Author     : HP
--%>
...
.dropdown:hover .dropdown-content {
    ...
    .button1 {
        padding-bottom: 8px; padding-top: 8px; padding-left: 21px; padding-right: 21px;
                font-size: 16px; border:1px solid darkred; 
                color: darkred; background-color: lightsalmon;
    }
    ...
    .button2:hover{cursor: pointer;
        ...
        function ()
        {
        $('#load_me').load('CurrentOrdersCH.jsp').fadeIn("slow");
            ...
            <tbody >
                <tr >
                    <td width="1325px" align="center"> 
                        <br><h2 align="center" style="color:yellow">These are your current orders.</h2>
                        <h1 align="center" style="color:orange">        </h1>
               
                         <div id="load_me">
<%@ include file="CurrentOrdersCH.jsp" %>
</div>   
