<%-- 
    Document   : constructor_contacting
    Created on : May 4, 2018, 6:29:26 PM
    Author     : HP
--%>
...
.dropdown:hover .dropdown-content {
    ...
    .submit4:hover{cursor: pointer;
        ...
        function ()
        {
        $('#load_me').load('ShowGuestMsg.jsp').fadeIn("slow");
...
<br><p style="font-size:16px;text-align: left"> You are logged-in.</p><p style="font-size:23px;text-align: left">Welcome <%=g %><%=r %></p>
    ...
    <tr> 
        <td width="1100px"><h1 align="center" style="color: lightblue;">Guest Messages</h1></td>
      ...
      <form method="post" action="Logout"><input type="image" value="submit" onclick="return(con());" src="pho/std.png" width="60px" heigth="35px" alt="submit Button" onMouseOver="this.src='pho/std.png'" title="click to logout."></form>  
        ...
        <table border="0" cellpadding="5" align="right" style="color:white;">
...
<form method="post" action="msgdelguest">
    <input type="submit" onclick="return(sure());" value="Delete all" class="submit submit4">
</form>                
