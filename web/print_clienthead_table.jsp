<%-- 
    Document   : print_clienthead_table
    Created on : May 12, 2018, 1:38:46 AM
    Author     : HP
--%>
...
<%! String n1 = null; %><%! String num1 = null; %>
 <%
//allow access only if session exists
String r1 = null; String g1 = null; 
if((session.getAttribute("r") == null)&&(session.getAttribute("g") == null)&&(session.getAttribute("n") == null)&&(session.getAttribute("num1") == null)){
	response.sendRedirect("myhome2.html");
}else r1 = (String) session.getAttribute("r"); g1 = (String) session.getAttribute("g"); n1 = (String) session.getAttribute("n"); num1 = (String) session.getAttribute("num");
...
PreparedStatement p = (PreparedStatement)con.prepareStatement("SELECT * FROM "+num1+"  ");
