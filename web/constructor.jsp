...
.dropdown:hover .dropdown-content {
    ...
    .button1 {
        padding-bottom: 8px; padding-top: 8px; padding-left: 21px; padding-right: 21px;
                font-size: 16px; border:1px solid gray; 
                color: white; background-color: black;
    }
    .button1:hover{cursor: pointer;
        font-size: 14px; border:3px solid gold; 
                
    }
    .button2 {
        padding-bottom: 8px; padding-top: 8px; padding-left: 21px; padding-right: 21px;
                font-size: 16px; border:1px solid darkcyan; 
                color: darkcyan; background-color: darkkhaki;
    }
    .button2:hover{cursor: pointer;
        font-size: 14px; border:3px solid darkcyan; 
        ...
        function ()
        {
        $('#load_me').load('CurrentOrders.jsp').fadeIn("slow");
   ...
   {
       var val = confirm("You are about to CLOSE the following project. Please confirm.");
       if (val==true)return true; else return false;
   }
   function con()
   {
...
<table>
    <tr><td>
                        <form method="post" action="GM"><input type="submit" class="submit button1" value="Check your Guest Messages"></form>       
        </td><td><form method="post" action="OC"><input type="submit" class="submit button1" value="New Orders to be confirmed"></form>       
                    </td> </tr>
</table>        <table border="0" cellpadding="5" style="color:white;">
           
            <tbody >
                <tr >
                    <td width="1325px" align="center"> 
                       
                        <h1 align="center" style="color:orange">        </h1>
                
                         <div id="load_me">
<%@ include file="CurrentOrders.jsp" %>
</div>   
